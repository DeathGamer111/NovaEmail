...
The demo never submits staged messages. Choosing **Stage in Outbox** persists a complete MIME message—including locally selected attachments—so compose and reply workflows can be exercised without contacting an SMTP server.
